  ...
  return (
    <div className='p-4 px-8 flex flex-col gap-3'>
        ...
        <div>
            ...
            <Input onChange={(event)=>setUserNotes(event.target.value)}/>
        </div>
        <div>
            <h2 className='text-xs text-gray-400'>By Proceeding, you confirm that you read and agree to Company's Terms and Conditions</h2>
        </div>
    </div>
  )
}
